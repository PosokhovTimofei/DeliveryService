...
func (c *authServiceClient) RegisterModerator(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
...
func (UnimplementedAuthServiceServer) RegisterModerator(context.Context, *RegisterRequest) (*AuthResponse, error) {
...
func _AuthService_RegisterModerator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).RegisterModerator(ctx, req.(*RegisterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
